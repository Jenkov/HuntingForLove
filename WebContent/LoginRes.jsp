...
<script type ="text/javascript">
	setTimeout('window.location="right.jsp"',3000);
</script>
<style type="text/css">
	body{
...
<ul  class="nav navbar-nav">
	...
	<jsp:useBean id="login" type="mybean.Login" scope ="session"></jsp:useBean>

<% if(login.getStatus()==true)
     {
 %>   
 		<br><jsp:getProperty name ="login" property = "feedback" />
